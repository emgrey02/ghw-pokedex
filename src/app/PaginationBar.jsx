        ...
        <div className='flex flex-row justify-center align-center h-full w-full'>
            <ul className='grid grid-cols-11 place-items-center h-min w-full'> 
                <li className='hover:bg-indigo-900/60 dark:hover:bg-indigo-400 rounded transition'>
                    <Link className='p-2 stroke-slate-700 dark:stroke-slate-400 hover:stroke-slate-900 transition' href={`/?page=1`} page={1}>
                        <svg
                ...
                <li>
                    <div className={`${currentPage <= 3 ? 'invisible' : ''}`} >...</div>
                </li>
                {pages.map((p) => (
                    <li className='hover:bg-slate-900/20 dark:hover:bg-slate-900 rounded transition' key={p}>
                        <Link className={`block p-2 ${p == currentPage ? 'text-xl underline font-bold text-indigo-950/80 dark:text-indigo-400' : ''} w-min`} href={`/?page=${p}`} page={p}>{p}</Link>            
                    </li>
                ))}
                <li>
